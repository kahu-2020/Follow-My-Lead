      ...
      <div>
        ...
        <div className="form-container">
          <form className="form" onSubmit={this.handleSubmit}>
            ...
            >
              <option value="select">select</option>
              <option value="Small">Small 9kg or less</option>
              <option value="Medium">Medium 10-22kg</option>
              <option value="Large">Large 22kg or more</option>
            </select>
            <br />
            ...
            >
              <option value="select">select</option>
              <option value="30-45mins">30-45 minutes</option>
              <option value="45-60mins">45-60 minutes</option>
              <option value="60-90mins">60-90 minutes</option>
            </select>
            <br />
