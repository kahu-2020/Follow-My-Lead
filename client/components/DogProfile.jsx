  ...
  componentDidMount() {
    ...
    getUserDetails(this.state.user_id).then(user => {
      if (user.walker) {
        ...
        getDog(this.props.match.params.id).then(dog => {
    ...
    returnFeedback(this.props.match.params.id).then(feedbackInfo => {
      this.setState({
    ...
    return (
      <>
        ...
        <div className="profile-container">
          ...
          <p>
            {' '}
            <strong>Suburb: </strong> {this.state.suburb}
          </p>
          <br />
          ...
          {this.state.request_sent && (
            <div>
              ...
              <a
                className="button"
                className="move"
                href="https://move-v1.herokuapp.com/"
              >
                MOVE
              </a>
              <p>for some awesome walking spots in Wellington</p>
            </div>
          )}
        </div>
      </>
